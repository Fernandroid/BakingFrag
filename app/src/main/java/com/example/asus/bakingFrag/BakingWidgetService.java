...
class BakingRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public void onDataSetChanged() {
        Timber.i("onDatasetChanged called");
        Gson gson = new Gson();
        SharedPreferences sharedPref = mContext.getSharedPreferences(mContext.getString(R.string.preferece_file_key), mContext.MODE_PRIVATE);
        String stringRecipe = sharedPref.getString(mContext.getString(R.string.file_json_key), null);
        mName = sharedPref.getString(mContext.getString(R.string.recipe_name_key), null);
